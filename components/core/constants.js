...
export const messages = {
  ...
  FAILED_TO_SIGN_IN_EXPIRED: `Failed to sign in the system. This account is expired.`,
  INCORRECT_USER_INFO: `Incorrect user info.`,
  ...
  SERVER_NOT_SUPPORTED_METHOD: `Not supported method.`,
