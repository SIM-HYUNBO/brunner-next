...
export default function Layout({ children, reloadSignal, triggerLeftMenuReload }) {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-primary justify-center desktop:pl-10">
      <LeftMenu
        documentList={documentList}
        reloadSignal={reloadSignal}
      />

      <DivContainer className="flex flex-col w-full desktop:px-4 ml-10">
