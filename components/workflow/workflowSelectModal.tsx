...
const WorkflowSelectModal: React.FC<WorkflowSelectModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-lg shadow-lg w-[700px] max-h-[80vh] flex flex-col"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            <div className="p-5 text-center text-gray-500">불러오는 중...</div>
          ) : (
              ...
              <tbody>
                ...
                {workflows.length === 0 && !loading && (
                  <tr>
                    <td
                      colSpan={3}
                      className="text-center text-gray-500 py-5 border-t"
                    >
                      등록된 워크플로우가 없습니다.
                    </td>
                  </tr>
