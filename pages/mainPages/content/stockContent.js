                ...
                <div >
                    ...
                    <div className="content-governing-text">
                        ...
                        <p className="items-start">
                            두 개의 이동평균선 (단기와 장기 이동평균) 사이의 차이를 나타내는 지표입니다.<br />
                    ...
                    <div className="content-governing-text flex">
                        ...
                        <p className="items-start">
                            최근 가격 데이터에 더 큰 가중치를 주어 계산하는 이동평균의 한 유형입니다.
                        </p>
                    </div>
                    <div className="content-governing-text flex">
                        <h2>Stochastic Oscillator(스토캐스틱 오실레이터)</h2>
                        <p className="items-start">
                            주식 시장에서 가격이 일정 기간 내에서 상대적으로 어디에 위치하는지를 나타내는 기술적 지표입니다.<br />
