        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
              ...
              <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Brunner와 함께하는 것은 교육센터를 통해서만 가능합니다. 별도의 입사지원 없이 교육센터에서 교육과정을 이수한 인재를 선발하여 적합한 업무를 배정합니다. 누구나 언제든 도전할 수 있습니다.</p>
            </div>
            ...
            <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">지원하기</button>
          </div>
        </section>
        </div>
      </section>
